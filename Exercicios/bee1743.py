...
for ciclo in range(len(conect1)):
    valort1 = conect1[ciclo]
    valort2 = conect2[ciclo]
    
    if (valort1 == 1 and valort2 == 1) or (valort1 == 0 and valort2 == 0):
        print('N')
        break

    if (valort1 == 0 and valort2 == 1) or (valort1 == 1 and valort2 == 0):
        verificacoes += 1

    if verificacoes == len(conect1):
        print('Y')
        break
